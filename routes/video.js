...
Router.post('/upload',checkAuth,async(req,res)=>{
    ...
    const newVideo = new Video({
        ...
        user_id:user._id,//token se jo user ka id mil raha hai and id jo dtat ka id hai
...
Router.put('/:videoId',checkAuth,async(req,res)=>{
    try
    {
       ...
       //console.log(verifiedUser)//token banate waqt joo joo data use kiye the wo sara verified user mai show hoaga
       const video = await Video.findById(req.params.videoId)
       //console.log(video)//here we get video information
